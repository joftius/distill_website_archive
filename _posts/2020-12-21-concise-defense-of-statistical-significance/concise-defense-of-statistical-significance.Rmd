...
description: |
  Recent arguments against the use of p-values and significance testing are mostly weak. The weak ones actually arguments against making decisions or mistakes in general, which is impossible.
author:
  - name: Joshua Loftus
