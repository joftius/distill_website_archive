...
- [Stat-GB.4304](../ms4ds/): Modern statistics for data science
- [Stat-UB.103](http://stats103.org/): Introductory statistics (created by Vinu Abeywick)
- [Stat-UB.103 (old)](../introstats/): Statistics for business: control, regression, and forecasting
- Stat-UB.003: Regression and forecasting (page not active)
- [Stats 390](http://joshualoftus.com/stats390.html): Statistical Consulting Workshop (at Stanford, old page)
