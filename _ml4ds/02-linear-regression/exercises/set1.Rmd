...
-   Next, use the `loess` function to fit a non-linear model, and create a plot showing the prediction lines from both of these models. Comment on the relative strengths and weaknesses of these models.
