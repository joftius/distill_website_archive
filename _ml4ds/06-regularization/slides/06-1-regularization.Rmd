...
Consider estimating $\mu \in \mathbb R^p$ from an i.i.d. sample
$$
Y_1, \ldots, Y_n \sim N(\mu, \sigma^2 I)
$$
- The MLE is $\bar Y$ (obviously the best, right?)

- [Charles Stein](https://news.stanford.edu/2016/12/01/charles-m-stein-extraordinary-statistician-anti-war-activist-dies-96/) discovered in the 1950's that the MLE is *inadmissible* if $p > 2$

- The [James-Stein estimator](https://en.wikipedia.org/wiki/Stein%27s_example) **shrinks** $\bar Y$ toward some other point, any other point, chosen *a priori*

Intuition: $\| \bar Y - \mu \|_2^2/\sigma$ is a $\chi^2_p$ random variable, which "concentrates" -- has a high probability of being near its expectation which is $p$. In other words, w.h.p. $\bar Y$ 
