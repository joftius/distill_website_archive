...
[Notebook](notebooks/validation.Rmd) for validation ([partially complete](notebooks/validation_incomplete.html))

[Notebook](notebooks/lasso.Rmd) for lasso (no partially complete version)