...
## A few things you've heard about

- **Stochastic gradient descent**
- Ridge regression
- A little about **lasso**
- Kernel ridge regression
- Kernel SVM and other methods with **tuning parameters**
- Trees and random forests with **tuning parameters**
- Selecting tuning parameters with **cross-validation**

This week we'll say a bit more about **some of these**

Some theory/inference for interpretable models

(And in the next video we'll leave the world of interpretable models and focus on **neural networks** and **deep learning**)
