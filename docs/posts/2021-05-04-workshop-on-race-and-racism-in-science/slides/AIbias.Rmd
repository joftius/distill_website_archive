...
- Consumption: Amazon
- Labor: ghost work?
- Environment: e.g. cobalt extraction, also labor (anatomy of AI / global picture)
...
Another possible drawback: maybe *this task should not be scaled up* (or done at all)?
