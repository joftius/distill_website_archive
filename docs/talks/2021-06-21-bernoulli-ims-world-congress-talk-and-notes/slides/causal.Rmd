...
**Can we change the DAG**, for example via socialization or education- emphasizing more women role models in STEM curricula?
...
- Intervening (earlier?) in the ML pipeline, breaking feedback loops

- Modeling construction of social categories

- Measuring inequality before and after interventions
...
For another recent paper: [blog post](https://nyudatascience.medium.com/the-impact-remediation-framework-discovering-optimal-intervention-policies-to-improve-equity-dfeea9d03cef) and [10min video](https://youtu.be/dnadhGEDIBQ?t=5340)

[joshualoftus.com](joshualoftus.com) where these slides are available, with links

Longer version of this talk: [video](https://youtu.be/0xju3pEbPFE)
